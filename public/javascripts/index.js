...
const Warranties = {
    ...
    create: function(name, purchaseDate, expireDate) {
        var body = null;
        ...
        fetch(API_URL.CREATE, {
            ...
            if (status.success) {
                Warranties.inlineAdd(status.id, name, purchaseDate, expireDate);
            } else {
    ...
    update: function (id, name, purchaseDate, expireDate) {
        var body = null;
        ...
        fetch(API_URL.UPDATE, {
            ...
            if (status.success) {
                Warranties.inlineEdit(id, name, purchaseDate, expireDate);
            } else {
                console.warn('not saved!', status);
            }
        })
    ...
    inlineAdd: function (id, name, purchaseDate, expireDate) {
        this.list.push({
            id,
            name,
            purchaseDate,
    ...
    save: function() {
        ...
        if (this.EditID) {
            this.update(this.EditID, name, purchaseDate, expireDate);
        } else {
            this.create(name, purchaseDate, expireDate);
        }
    },
